...
\newcommand\semicircleunit[4]
{
    ...
    %formulas
    \node[left of=circle#4, node distance=1.2cm, align=center, text=blue1] (text1#4) {  \large $\underbrace{y_#4^\top x + b_#4}$ \\ \large $z_#4$};
    \node[right of=circle#4, node distance=1.2cm, align=center, text=red] (text2#4) { $a_#4 = \dfrac{e^{z_#4}}{\sum_{i=1}^K e^{z_i}}$};
...
%softmax layer
\node[rounded corners, draw, inner xsep = 3cm, inner ysep=14cm, fill=black!5] (largerec) at(0,-10){};
\semicircleunit{0}{0}{2.4}{1};
\semicircleunit{0}{-6}{2.4}{2};
\semicircleunit{0}{-20}{2.4}{K};
...
%output
\draw[thick] (9,1) -- (10,1) -- (10,-21) -- (9,-21);
