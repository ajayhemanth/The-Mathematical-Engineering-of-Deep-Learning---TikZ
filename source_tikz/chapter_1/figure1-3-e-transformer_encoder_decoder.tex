...
\newcommand\lhs[1]
{
    \node[left of = unit#1, node distance=1.7cm] (side#1) {\Large {$z^{\star}$}};
    ...
    \draw[-, dashed, thickline] ([xshift=-2mm, yshift=4mm]unit#1.west) -- ([xshift=-2mm, yshift=-4mm]unit#1.west);
}
...
\node[redshape, rounded corners, minimum width=2cm, minimum height=4cm, align=center, node distance=4cm, right of = unit1] (unit2) { Transformer\\Decoder };
...
\node[redshape, rounded corners, minimum width=2cm, minimum height=4cm, align=center, node distance=4cm, right of = unit2] (unit3) { Transformer\\Decoder };
...
\draw[-Triangle, thickline, bend left, looseness=1] (top2.east) to[out=90, in=-90] ([xshift=-1.3cm]bottom3);
\draw[-Triangle, thickline, bend right, looseness=1] (top3.east) to[out=90, in=-90] ([xshift=3cm]bottom3);
